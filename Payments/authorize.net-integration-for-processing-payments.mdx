---
title: "Authorize.net integration for processing payments."
description: "Authorize.Net is considered a competitive payment processor due to its reliability, security, and wide range of features."
---
...
>  
>**Stripe: [https://stripe.com/gb/pricing](https://stripe.com/gb/pricing)**  
>**Paypal: [https://www.paypal.com/us/webapps/mpp/merchant-fees]>(https://www.paypal.com/us/webapps/mpp/merchant-fees)**  
>**Authorize.net: [https://www.authorize.net/en-us/sign-up/pricing.html](https://www.authorize.net/en-us/sign-up/pricing.html)**

## Requirements to use Authorize.Net

Authorize.net can accept transactions from  [the United States, Australia, and Canadian](https://support.authorize.net/knowledgebase/Knowledgearticle/?code=000001207)  merchants.  
...
[Click Here](https://developer.authorize.net/hello_world/testing_guide.html)  for more details on Sandbox vs. Live Mode in  [Authorize.Net](https://authorize.net/).

[Video Placeholder https://www.loom.com/share/48a47926cee941f2b8b9209fca6bb352?sid=a485850d-14dd-4106-92cf-60504574b921]

2. Then you can proceed to  **Payments> Integrations>**Drop the 3 API Keys you got from your  **Merchant Interface**  in  [Authorize.Net](https://authorize.net/).
...
3. It will show you a quick prompt asking whether you want to make  [](https://authorize.net/)Authorize.Net [](https://authorize.net/) your Default Payment Gateway.  
...
Clicking on  **Cancel** will still integrate  [](https://authorize.net/)Authorize.Net but will not make it the Default Gateway.
...
Clicking on  **Confirm**  will integrate  [](https://authorize.net/)Authorize.net[](https://authorize.net/)  and make it the Default Payment Gateway.
...
**Please Note:**
>You need to upgrade to funnels version 2 to make use of this feature.

[Click here](https://account.authorize.net/help/Miscellaneous/FAQ/Frequently_Asked_Questions.htm)  for the link to  [](https://authorize.net/)Authorize.Net[](https://authorize.net/)'s FAQ section.
...
Yes,  [Authorize.net](https://authorize.net/) is available for membership checkouts
