---
title: "How to create invoices in Monstro"
description: "Invoicing is a very important part of any business. It helps you keep track of your expenses, and it also allows you to get paid for the work that you do."
---
## How to create invoices in Monstro
...
>
>The limitation to using invoicing without Stripe Connect is that the user will need to manually record the payments
...
**Step 5: Once you add the product it will allow you to edit the price and edit quantity as well**  
**
...
**Step 1:**  Once you create the invoice you can send that to your client using the green button in the top right corner.  
...
You can also look for successful, or failed transactions related to invoices. You can directly open the invoices as well.**Payments > transactions**
