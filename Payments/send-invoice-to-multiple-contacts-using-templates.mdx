---
title: "Send Invoice to Multiple Contacts using templates"
description: "This will enable quick and easy creation of one-time/recurring invoices and will also enable sending invoices in a workflow using the same templates created."
---
