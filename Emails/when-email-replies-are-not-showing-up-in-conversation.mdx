...
[](https://support.mymonstro.com/category/emails/doc/when-email-replies-are-not-showing-up-in-conversation#3-check-if-you-are-using-the-root-domain-with-google-workspace-and-mailgun)
