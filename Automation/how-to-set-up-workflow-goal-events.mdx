...
For the "**Clicked Trigger link,**" please select the trigger links listed in the dropdown menu. If you have not created a trigger link, please check out this article before continuing: [Trigger Links - Overview](![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155000617150/original/m8aosRgNxWWLr89GKKLseb9NDHDR1bAZ7g.gif?1686137755)
