---
title: "Standard Triggers - Contact Tag"
description: "Tags are used for searching, browsing, sorting, and organizing content. Tags are also allow you to fire off automation, bulk Emails, SMS, etc."
---
...
**Please Note:**
>CSV Imports are also used to update the tags of existing contacts, if Allow Duplicate contacts are turned off and the Email and Phone of the contacts being imported are the same as the already existing ones.