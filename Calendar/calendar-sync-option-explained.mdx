...
description: "The updated sync option found in the Settings->Profile page after integrating the Google account."
---
...
#### All HL appointments will still be pushed to the linked Google calendar no matter what the sync option is.
...
All events from Google Calendar will be shown in grey. It will not add whoever is invited to the Google event to Monstro. But will still sync the Appointments from HL to the Google calendar and block the timeslot pulled from Google.
