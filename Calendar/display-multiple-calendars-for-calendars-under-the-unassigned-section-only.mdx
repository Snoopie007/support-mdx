---
title: "Display Multiple Calendars (For calendars under the Unassigned section only)"
description: "Showing the multiple calendars (Unassigned section only)."
---
...
2. Copy the calendar ID from one calendar then go to the other calendar, add a comma after its ID, paste the other calendar's ID after the comma, and hit enter to reload the page
...
3. Go to the funnel page, add a "Custom JS/HTML" element, click "Open Code Editor", and paste the calendar embed code.
...
4. 
5. Go back to the funnel page tab that has your Custom JS/HTML element code editor open, add a comma after the calendar ID, paste the second calendar ID, and then hit "Yes, save."
...
7. Save your funnel page and preview.