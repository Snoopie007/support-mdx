...
---
title: "Display Multiple Calendars. This is for calendars under the Unassigned section only."
description: "Showing the multiple calendars in the unassigned section only."
...
4. Go back to the funnel page tab that has your Custom JS/HTML element code editor open, add a comma after the calendar ID, paste the second calendar ID, and then hit "Yes, save."
