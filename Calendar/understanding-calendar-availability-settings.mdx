---
title: "Understanding Calendar Availability Settings "
description: "This delves into the nuances of appointment slot settings, demonstrating their functionality through practical examples and advanced use cases."
---
...
A Slot buffer will add buffer time after every appointment, preventing another booking until the buffer time has expired. Let's say an appointment is booked from 10:00 to 10:30, and you have a slot buffer of 15 minutes; then the next available slot will be at 10:45.Let'sa
