...
**Please note:**
>We have a limitation on the "times to repeat" field. An event can be repeated for a maximum of 24 times.
...
**Please Note:**
>We are deprecating the Customer Booked Appointment Trigger. So now, if you select the Modified By Filter: 
