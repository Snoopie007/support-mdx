...
**Please Note** In the Contact Export section, if users have selected the email option in the smartlist column, a new column named “Additional Email” will automatically appear in the exported CSV file. This column will contain all the additional emails arranged in one column and separated by commas(,).
